...
import { headerOpen, headerClose } from '../../action/Header'
    ...
    return (
        <div className={classes.root}>
            ...
            <IconButton
                ...
                className={classNames(classes.headerButton, classes.subHeaderClosed, headerOpened && classes.hide, {
                    [classes.headerButtonShift]: !openSideMenu
                })}
            >
            ...
            <IconButton
                ...
                className={classNames(classes.menuButton, openSideMenu && classes.hide, classes.sideMenuOpened)}
            >
                <ChevronLeftIcon />
            </IconButton>
            <IconButton
                onClick={() => setOpenSideMenu(false)}
                className={classNames(classes.menuButton, !openSideMenu && classes.hide, classes.sideMenuClosed)}
            >
                <ChevronRightIcon />
            </IconButton>
        </div>
