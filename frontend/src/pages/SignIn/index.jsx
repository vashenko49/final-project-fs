...
import Logo from '@pages/Dashboard/Header/Logo/Logo';
...
const SignIn = ({ history }) => {
  ...
  const responseLogin = useSelector(Login.getAuth);
      ...
      <div className={classes.paper}>
        ...
        <form className={classes.form} noValidate>
          ...
          {!responseLogin.success && (
            <FormHelperText error={!responseLogin.success}>{t('signInFail')}</FormHelperText>
          )}
          <FormControlLabel
            control={
              <Checkbox
